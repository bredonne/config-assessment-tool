                ...
                for dashboard in application["apmDashboards"]:
                    if str(application["name"]) in dashboard["applicationNames"]:
                        ...
                        for apmReport in application["apmReports"]:
                            list = apmReport["reportDataIds"]  #Any dataID that comes in this field, will be the ID of the dashboard configured in the report.
                                                                #application[apmDashboards] do not have the ID of the dashboard. Must find a way to get the ID and make the link.
