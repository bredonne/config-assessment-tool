...
class BusinessTransactionsAPM_WF(JobStepBase):
    def __init__(self):
        super().__init__("apm")
    ...
    def analyze(self, controllerData, thresholds):
        ...
        for host, hostInfo in controllerData.items():
            ...
            for application in hostInfo[self.componentType].values():
                ...
                numberOfCustomMatchURLRules = 0
                numberOfCustomMatchMethodRules = 0
                numberOfCustomMatchHTTPParameterRules = 0
                if "ruleScopeSummaryMappings" in application["btMatchRules"]:
                    for rule in application["btMatchRules"]["ruleScopeSummaryMappings"]:
                        if rule["rule"]["summary"]["name"] not in defaultBtNameList and rule["rule"]["enabled"]:
                ...
                analysisDataEvaluatedMetrics["numberOfCustomMatchHTTPParameterRules"] = numberOfCustomMatchHTTPParameterRules
                ...
                analysisDataRawMetrics["numberOfCustomMatchURLRules"] = numberOfCustomMatchURLRules
                analysisDataRawMetrics["numberOfCustomMatchMethodRules"] = numberOfCustomMatchMethodRules
                analysisDataRawMetrics["numberOfCustomMatchHTTPParameterRules"] = numberOfCustomMatchHTTPParameterRules
